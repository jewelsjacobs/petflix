...
export default function ThemeSelectionScreen() {
  ...
  const { selectedImageUri, setSelectedTheme } = useAppContext();
  ...
  const handleNextPress = () => {
    if (selectedThemeId && selectedImageUri) {
      console.log(`Selected Theme: ${selectedThemeId}, Image URI: ${selectedImageUri}`);
      router.push('/video-generation');
    } else {
      console.error("Theme or Image URI missing from context or state");
      Alert.alert("Missing Information", "Please ensure an image and theme are selected.");
    }
  };
