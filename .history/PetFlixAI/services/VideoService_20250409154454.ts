...
const THEME_DETAILS: { [key: string]: { prompt: string; style?: string; aspect_ratio?: string } } = {
  'fairy-tale': { prompt: 'A whimsical fairy tale scene featuring the subject of the image.', style: 'T2V-01-Circular', aspect_ratio: '16:9' },
  'crime-drama': { prompt: 'A gritty, noir crime drama scene featuring the subject of the image.', style: 'T2V-01-Horizontal', aspect_ratio: '16:9' }, // Example style change
  'romance': { prompt: 'A heartwarming romantic scene featuring the subject of the image.', style: 'T2V-01-ZoomIn', aspect_ratio: '16:9' }, // Example style change
  'sci-fi': { prompt: 'A futuristic sci-fi scene featuring the subject of the image.', style: 'T2V-01-DollyZoom', aspect_ratio: '16:9' }, // Example style change
};
