...
export const generateVideo = async ({ 
  ...
  try {
    ...
    */
    ...
    // Provide a more generic, user-friendly message unless it's a specific known case
    let userErrorMessage = "Something went wrong while creating your video. Please check your connection and try again.";
    if (error instanceof Error) {
        // You could potentially check for specific error messages here if needed
        // e.g., if (error.message.includes('timed out')) { userErrorMessage = ... }
    }
